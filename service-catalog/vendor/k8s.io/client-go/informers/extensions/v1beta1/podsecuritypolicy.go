...
import (
	...
	v1 "k8s.io/client-go/listers/extensions/v1"
...
type PodSecurityPolicyInformer interface {
	...
	Lister() v1.PodSecurityPolicyLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.Extensionsv1().PodSecurityPolicies().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.Extensionsv1().PodSecurityPolicies().Watch(context.TODO(), options)
			},
		},
		&extensionsv1.PodSecurityPolicy{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *podSecurityPolicyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&extensionsv1.PodSecurityPolicy{}, f.defaultInformer)
}

func (f *podSecurityPolicyInformer) Lister() v1.PodSecurityPolicyLister {
	return v1.NewPodSecurityPolicyLister(f.Informer().GetIndexer())
}
