...
func (c *Extensionsv1Client) DaemonSets(namespace string) DaemonSetInterface {
	return newDaemonSets(c, namespace)
}

func (c *Extensionsv1Client) Deployments(namespace string) DeploymentInterface {
	return newDeployments(c, namespace)
}

func (c *Extensionsv1Client) Ingresses(namespace string) IngressInterface {
	return newIngresses(c, namespace)
}

func (c *Extensionsv1Client) NetworkPolicies(namespace string) NetworkPolicyInterface {
	return newNetworkPolicies(c, namespace)
}

func (c *Extensionsv1Client) PodSecurityPolicies() PodSecurityPolicyInterface {
	return newPodSecurityPolicies(c)
}

func (c *Extensionsv1Client) ReplicaSets(namespace string) ReplicaSetInterface {
