...
var ingressesResource = schema.GroupVersionResource{Group: "extensions", Version: "v1", Resource: "ingresses"}

var ingressesKind = schema.GroupVersionKind{Group: "extensions", Version: "v1", Kind: "Ingress"}

// Get takes name of the ingress, and returns the corresponding ingress object, and an error if there is any.
func (c *FakeIngresses) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1.Ingress, err error) {
	obj, err := c.Fake.
...
func (c *FakeIngresses) List(ctx context.Context, opts v1.ListOptions) (result *v1.IngressList, err error) {
	obj, err := c.Fake.
...
func (c *FakeIngresses) Create(ctx context.Context, ingress *v1.Ingress, opts v1.CreateOptions) (result *v1.Ingress, err error) {
	obj, err := c.Fake.
...
func (c *FakeIngresses) Update(ctx context.Context, ingress *v1.Ingress, opts v1.UpdateOptions) (result *v1.Ingress, err error) {
	obj, err := c.Fake.
...
func (c *FakeIngresses) UpdateStatus(ctx context.Context, ingress *v1.Ingress, opts v1.UpdateOptions) (*v1.Ingress, error) {
	obj, err := c.Fake.
...
func (c *FakeIngresses) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(ingressesResource, c.ns, name), &v1.Ingress{})
...
func (c *FakeIngresses) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1.Ingress, err error) {
	obj, err := c.Fake.
