...
func newIngresses(c *Extensionsv1Client, namespace string) *ingresses {
	return &ingresses{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *ingresses) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1.Ingress, err error) {
	result = &v1.Ingress{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("ingresses").
...
func (c *ingresses) List(ctx context.Context, opts v1.ListOptions) (result *v1.IngressList, err error) {
...
func (c *ingresses) Create(ctx context.Context, ingress *v1.Ingress, opts v1.CreateOptions) (result *v1.Ingress, err error) {
	result = &v1.Ingress{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("ingresses").
...
func (c *ingresses) Update(ctx context.Context, ingress *v1.Ingress, opts v1.UpdateOptions) (result *v1.Ingress, err error) {
	result = &v1.Ingress{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("ingresses").
...
func (c *ingresses) UpdateStatus(ctx context.Context, ingress *v1.Ingress, opts v1.UpdateOptions) (result *v1.Ingress, err error) {
	result = &v1.Ingress{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("ingresses").
...
func (c *ingresses) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1.Ingress, err error) {
	result = &v1.Ingress{}
