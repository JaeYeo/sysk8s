...
func (c *FakeClusterRoleBindings) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1.ClusterRoleBinding, err error) {
	obj, err := c.Fake.
...
func (c *FakeClusterRoleBindings) List(ctx context.Context, opts v1.ListOptions) (result *v1.ClusterRoleBindingList, err error) {
	obj, err := c.Fake.
...
func (c *FakeClusterRoleBindings) Create(ctx context.Context, clusterRoleBinding *v1.ClusterRoleBinding, opts v1.CreateOptions) (result *v1.ClusterRoleBinding, err error) {
	obj, err := c.Fake.
...
func (c *FakeClusterRoleBindings) Update(ctx context.Context, clusterRoleBinding *v1.ClusterRoleBinding, opts v1.UpdateOptions) (result *v1.ClusterRoleBinding, err error) {
	obj, err := c.Fake.
...
func (c *FakeClusterRoleBindings) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1.ClusterRoleBinding, err error) {
	obj, err := c.Fake.
