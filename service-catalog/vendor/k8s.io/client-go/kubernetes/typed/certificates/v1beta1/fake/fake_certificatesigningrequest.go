...
func (c *FakeCertificateSigningRequests) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1.CertificateSigningRequest, err error) {
	obj, err := c.Fake.
...
func (c *FakeCertificateSigningRequests) List(ctx context.Context, opts v1.ListOptions) (result *v1.CertificateSigningRequestList, err error) {
	obj, err := c.Fake.
...
func (c *FakeCertificateSigningRequests) Create(ctx context.Context, certificateSigningRequest *v1.CertificateSigningRequest, opts v1.CreateOptions) (result *v1.CertificateSigningRequest, err error) {
	obj, err := c.Fake.
...
func (c *FakeCertificateSigningRequests) Update(ctx context.Context, certificateSigningRequest *v1.CertificateSigningRequest, opts v1.UpdateOptions) (result *v1.CertificateSigningRequest, err error) {
	obj, err := c.Fake.
...
func (c *FakeCertificateSigningRequests) UpdateStatus(ctx context.Context, certificateSigningRequest *v1.CertificateSigningRequest, opts v1.UpdateOptions) (*v1.CertificateSigningRequest, error) {
	obj, err := c.Fake.
...
func (c *FakeCertificateSigningRequests) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(certificatesigningrequestsResource, name), &v1.CertificateSigningRequest{})
	return err
}
...
func (c *FakeCertificateSigningRequests) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1.CertificateSigningRequest, err error) {
	obj, err := c.Fake.
