...
type IngressClassInterface interface {
	Create(ctx context.Context, ingressClass *v1.IngressClass, opts v1.CreateOptions) (*v1.IngressClass, error)
	Update(ctx context.Context, ingressClass *v1.IngressClass, opts v1.UpdateOptions) (*v1.IngressClass, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1.IngressClass, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1.IngressClassList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1.IngressClass, err error)
...
func (c *ingressClasses) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1.IngressClass, err error) {
...
func (c *ingressClasses) List(ctx context.Context, opts v1.ListOptions) (result *v1.IngressClassList, err error) {
...
func (c *ingressClasses) Create(ctx context.Context, ingressClass *v1.IngressClass, opts v1.CreateOptions) (result *v1.IngressClass, err error) {
	result = &v1.IngressClass{}
	err = c.client.Post().
		Resource("ingressclasses").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *ingressClasses) Update(ctx context.Context, ingressClass *v1.IngressClass, opts v1.UpdateOptions) (result *v1.IngressClass, err error) {
	result = &v1.IngressClass{}
	err = c.client.Put().
		Resource("ingressclasses").
...
func (c *ingressClasses) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1.IngressClass, err error) {
	result = &v1.IngressClass{}
