...
func (c *FakeIngressClasses) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1.IngressClass, err error) {
	obj, err := c.Fake.
...
func (c *FakeIngressClasses) List(ctx context.Context, opts v1.ListOptions) (result *v1.IngressClassList, err error) {
	obj, err := c.Fake.
...
func (c *FakeIngressClasses) Create(ctx context.Context, ingressClass *v1.IngressClass, opts v1.CreateOptions) (result *v1.IngressClass, err error) {
	obj, err := c.Fake.
...
func (c *FakeIngressClasses) Update(ctx context.Context, ingressClass *v1.IngressClass, opts v1.UpdateOptions) (result *v1.IngressClass, err error) {
	obj, err := c.Fake.
...
func (c *FakeIngressClasses) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(ingressclassesResource, name), &v1.IngressClass{})
	return err
}
...
func (c *FakeIngressClasses) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1.IngressClass, err error) {
	obj, err := c.Fake.
