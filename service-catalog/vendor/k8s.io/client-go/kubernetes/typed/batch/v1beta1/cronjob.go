...
func (c *cronJobs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1.CronJob, err error) {
	result = &v1.CronJob{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("cronjobs").
...
func (c *cronJobs) List(ctx context.Context, opts v1.ListOptions) (result *v1.CronJobList, err error) {
...
func (c *cronJobs) Create(ctx context.Context, cronJob *v1.CronJob, opts v1.CreateOptions) (result *v1.CronJob, err error) {
	result = &v1.CronJob{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("cronjobs").
...
func (c *cronJobs) Update(ctx context.Context, cronJob *v1.CronJob, opts v1.UpdateOptions) (result *v1.CronJob, err error) {
	result = &v1.CronJob{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cronjobs").
...
func (c *cronJobs) UpdateStatus(ctx context.Context, cronJob *v1.CronJob, opts v1.UpdateOptions) (result *v1.CronJob, err error) {
	result = &v1.CronJob{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cronjobs").
...
func (c *cronJobs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1.CronJob, err error) {
	result = &v1.CronJob{}
