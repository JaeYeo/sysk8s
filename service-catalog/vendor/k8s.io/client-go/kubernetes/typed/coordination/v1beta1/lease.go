...
type LeaseInterface interface {
	Create(ctx context.Context, lease *v1.Lease, opts v1.CreateOptions) (*v1.Lease, error)
	Update(ctx context.Context, lease *v1.Lease, opts v1.UpdateOptions) (*v1.Lease, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1.Lease, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1.LeaseList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1.Lease, err error)
	LeaseExpansion
}
...
func (c *leases) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1.Lease, err error) {
	result = &v1.Lease{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("leases").
...
func (c *leases) List(ctx context.Context, opts v1.ListOptions) (result *v1.LeaseList, err error) {
...
func (c *leases) Create(ctx context.Context, lease *v1.Lease, opts v1.CreateOptions) (result *v1.Lease, err error) {
	result = &v1.Lease{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("leases").
...
func (c *leases) Update(ctx context.Context, lease *v1.Lease, opts v1.UpdateOptions) (result *v1.Lease, err error) {
	result = &v1.Lease{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("leases").
...
func (c *leases) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1.Lease, err error) {
	result = &v1.Lease{}
