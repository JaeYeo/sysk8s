...
func (c *FakeLeases) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1.Lease, err error) {
	obj, err := c.Fake.
...
func (c *FakeLeases) List(ctx context.Context, opts v1.ListOptions) (result *v1.LeaseList, err error) {
	obj, err := c.Fake.
...
func (c *FakeLeases) Create(ctx context.Context, lease *v1.Lease, opts v1.CreateOptions) (result *v1.Lease, err error) {
	obj, err := c.Fake.
...
func (c *FakeLeases) Update(ctx context.Context, lease *v1.Lease, opts v1.UpdateOptions) (result *v1.Lease, err error) {
	obj, err := c.Fake.
...
func (c *FakeLeases) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(leasesResource, c.ns, name), &v1.Lease{})
...
func (c *FakeLeases) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1.Lease, err error) {
	obj, err := c.Fake.
