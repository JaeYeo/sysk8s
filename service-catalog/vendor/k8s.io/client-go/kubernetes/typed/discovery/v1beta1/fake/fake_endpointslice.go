...
func (c *FakeEndpointSlices) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1.EndpointSlice, err error) {
	obj, err := c.Fake.
...
func (c *FakeEndpointSlices) List(ctx context.Context, opts v1.ListOptions) (result *v1.EndpointSliceList, err error) {
	obj, err := c.Fake.
...
func (c *FakeEndpointSlices) Create(ctx context.Context, endpointSlice *v1.EndpointSlice, opts v1.CreateOptions) (result *v1.EndpointSlice, err error) {
	obj, err := c.Fake.
...
func (c *FakeEndpointSlices) Update(ctx context.Context, endpointSlice *v1.EndpointSlice, opts v1.UpdateOptions) (result *v1.EndpointSlice, err error) {
	obj, err := c.Fake.
...
func (c *FakeEndpointSlices) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(endpointslicesResource, c.ns, name), &v1.EndpointSlice{})
...
func (c *FakeEndpointSlices) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1.EndpointSlice, err error) {
	obj, err := c.Fake.
