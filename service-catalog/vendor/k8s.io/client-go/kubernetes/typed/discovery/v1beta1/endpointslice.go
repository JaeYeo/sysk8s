...
type EndpointSliceInterface interface {
	Create(ctx context.Context, endpointSlice *v1.EndpointSlice, opts v1.CreateOptions) (*v1.EndpointSlice, error)
	Update(ctx context.Context, endpointSlice *v1.EndpointSlice, opts v1.UpdateOptions) (*v1.EndpointSlice, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1.EndpointSlice, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1.EndpointSliceList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1.EndpointSlice, err error)
...
func (c *endpointSlices) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1.EndpointSlice, err error) {
...
func (c *endpointSlices) List(ctx context.Context, opts v1.ListOptions) (result *v1.EndpointSliceList, err error) {
...
func (c *endpointSlices) Create(ctx context.Context, endpointSlice *v1.EndpointSlice, opts v1.CreateOptions) (result *v1.EndpointSlice, err error) {
	result = &v1.EndpointSlice{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("endpointslices").
...
func (c *endpointSlices) Update(ctx context.Context, endpointSlice *v1.EndpointSlice, opts v1.UpdateOptions) (result *v1.EndpointSlice, err error) {
	result = &v1.EndpointSlice{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("endpointslices").
...
func (c *endpointSlices) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1.EndpointSlice, err error) {
	result = &v1.EndpointSlice{}
