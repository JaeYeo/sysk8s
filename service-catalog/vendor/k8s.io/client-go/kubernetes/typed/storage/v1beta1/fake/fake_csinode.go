...
func (c *FakeCSINodes) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1.CSINode, err error) {
	obj, err := c.Fake.
...
func (c *FakeCSINodes) List(ctx context.Context, opts v1.ListOptions) (result *v1.CSINodeList, err error) {
	obj, err := c.Fake.
...
func (c *FakeCSINodes) Create(ctx context.Context, cSINode *v1.CSINode, opts v1.CreateOptions) (result *v1.CSINode, err error) {
	obj, err := c.Fake.
...
func (c *FakeCSINodes) Update(ctx context.Context, cSINode *v1.CSINode, opts v1.UpdateOptions) (result *v1.CSINode, err error) {
	obj, err := c.Fake.
...
func (c *FakeCSINodes) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(csinodesResource, name), &v1.CSINode{})
	return err
}
...
func (c *FakeCSINodes) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1.CSINode, err error) {
	obj, err := c.Fake.
