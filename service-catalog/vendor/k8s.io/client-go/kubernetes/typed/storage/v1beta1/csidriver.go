...
type CSIDriverInterface interface {
	Create(ctx context.Context, cSIDriver *v1.CSIDriver, opts v1.CreateOptions) (*v1.CSIDriver, error)
	Update(ctx context.Context, cSIDriver *v1.CSIDriver, opts v1.UpdateOptions) (*v1.CSIDriver, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1.CSIDriver, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1.CSIDriverList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1.CSIDriver, err error)
	CSIDriverExpansion
}
...
func (c *cSIDrivers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1.CSIDriver, err error) {
	result = &v1.CSIDriver{}
	err = c.client.Get().
		Resource("csidrivers").
		Name(name).
...
func (c *cSIDrivers) List(ctx context.Context, opts v1.ListOptions) (result *v1.CSIDriverList, err error) {
...
func (c *cSIDrivers) Create(ctx context.Context, cSIDriver *v1.CSIDriver, opts v1.CreateOptions) (result *v1.CSIDriver, err error) {
	result = &v1.CSIDriver{}
	err = c.client.Post().
		Resource("csidrivers").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *cSIDrivers) Update(ctx context.Context, cSIDriver *v1.CSIDriver, opts v1.UpdateOptions) (result *v1.CSIDriver, err error) {
	result = &v1.CSIDriver{}
	err = c.client.Put().
		Resource("csidrivers").
		Name(cSIDriver.Name).
...
func (c *cSIDrivers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1.CSIDriver, err error) {
	result = &v1.CSIDriver{}
