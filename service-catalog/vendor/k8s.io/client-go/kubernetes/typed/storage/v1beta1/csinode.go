...
type CSINodeInterface interface {
	Create(ctx context.Context, cSINode *v1.CSINode, opts v1.CreateOptions) (*v1.CSINode, error)
	Update(ctx context.Context, cSINode *v1.CSINode, opts v1.UpdateOptions) (*v1.CSINode, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1.CSINode, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1.CSINodeList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1.CSINode, err error)
	CSINodeExpansion
}
...
func (c *cSINodes) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1.CSINode, err error) {
	result = &v1.CSINode{}
	err = c.client.Get().
		Resource("csinodes").
		Name(name).
...
func (c *cSINodes) List(ctx context.Context, opts v1.ListOptions) (result *v1.CSINodeList, err error) {
...
func (c *cSINodes) Create(ctx context.Context, cSINode *v1.CSINode, opts v1.CreateOptions) (result *v1.CSINode, err error) {
	result = &v1.CSINode{}
	err = c.client.Post().
		Resource("csinodes").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *cSINodes) Update(ctx context.Context, cSINode *v1.CSINode, opts v1.UpdateOptions) (result *v1.CSINode, err error) {
	result = &v1.CSINode{}
	err = c.client.Put().
		Resource("csinodes").
		Name(cSINode.Name).
...
func (c *cSINodes) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1.CSINode, err error) {
	result = &v1.CSINode{}
