...
func (c *FakeCSIDrivers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1.CSIDriver, err error) {
	obj, err := c.Fake.
...
func (c *FakeCSIDrivers) List(ctx context.Context, opts v1.ListOptions) (result *v1.CSIDriverList, err error) {
	obj, err := c.Fake.
...
func (c *FakeCSIDrivers) Create(ctx context.Context, cSIDriver *v1.CSIDriver, opts v1.CreateOptions) (result *v1.CSIDriver, err error) {
	obj, err := c.Fake.
...
func (c *FakeCSIDrivers) Update(ctx context.Context, cSIDriver *v1.CSIDriver, opts v1.UpdateOptions) (result *v1.CSIDriver, err error) {
	obj, err := c.Fake.
...
func (c *FakeCSIDrivers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(csidriversResource, name), &v1.CSIDriver{})
	return err
}
...
func (c *FakeCSIDrivers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1.CSIDriver, err error) {
	obj, err := c.Fake.
