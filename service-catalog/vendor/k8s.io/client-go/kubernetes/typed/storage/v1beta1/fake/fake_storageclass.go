...
func (c *FakeStorageClasses) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1.StorageClass, err error) {
	obj, err := c.Fake.
...
func (c *FakeStorageClasses) List(ctx context.Context, opts v1.ListOptions) (result *v1.StorageClassList, err error) {
	obj, err := c.Fake.
...
func (c *FakeStorageClasses) Create(ctx context.Context, storageClass *v1.StorageClass, opts v1.CreateOptions) (result *v1.StorageClass, err error) {
	obj, err := c.Fake.
...
func (c *FakeStorageClasses) Update(ctx context.Context, storageClass *v1.StorageClass, opts v1.UpdateOptions) (result *v1.StorageClass, err error) {
	obj, err := c.Fake.
...
func (c *FakeStorageClasses) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1.StorageClass, err error) {
	obj, err := c.Fake.
