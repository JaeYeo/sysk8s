...
type VolumeAttachmentInterface interface {
	Create(ctx context.Context, volumeAttachment *v1.VolumeAttachment, opts v1.CreateOptions) (*v1.VolumeAttachment, error)
	Update(ctx context.Context, volumeAttachment *v1.VolumeAttachment, opts v1.UpdateOptions) (*v1.VolumeAttachment, error)
	UpdateStatus(ctx context.Context, volumeAttachment *v1.VolumeAttachment, opts v1.UpdateOptions) (*v1.VolumeAttachment, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1.VolumeAttachment, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1.VolumeAttachmentList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1.VolumeAttachment, err error)
...
func (c *volumeAttachments) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1.VolumeAttachment, err error) {
...
func (c *volumeAttachments) List(ctx context.Context, opts v1.ListOptions) (result *v1.VolumeAttachmentList, err error) {
...
func (c *volumeAttachments) Create(ctx context.Context, volumeAttachment *v1.VolumeAttachment, opts v1.CreateOptions) (result *v1.VolumeAttachment, err error) {
	result = &v1.VolumeAttachment{}
	err = c.client.Post().
		Resource("volumeattachments").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *volumeAttachments) Update(ctx context.Context, volumeAttachment *v1.VolumeAttachment, opts v1.UpdateOptions) (result *v1.VolumeAttachment, err error) {
	result = &v1.VolumeAttachment{}
	err = c.client.Put().
		Resource("volumeattachments").
...
func (c *volumeAttachments) UpdateStatus(ctx context.Context, volumeAttachment *v1.VolumeAttachment, opts v1.UpdateOptions) (result *v1.VolumeAttachment, err error) {
	result = &v1.VolumeAttachment{}
	err = c.client.Put().
		Resource("volumeattachments").
		Name(volumeAttachment.Name).
...
func (c *volumeAttachments) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1.VolumeAttachment, err error) {
	result = &v1.VolumeAttachment{}
