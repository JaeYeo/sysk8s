...
type PriorityClassInterface interface {
	Create(ctx context.Context, priorityClass *v1.PriorityClass, opts v1.CreateOptions) (*v1.PriorityClass, error)
	Update(ctx context.Context, priorityClass *v1.PriorityClass, opts v1.UpdateOptions) (*v1.PriorityClass, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1.PriorityClass, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1.PriorityClassList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1.PriorityClass, err error)
...
func (c *priorityClasses) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1.PriorityClass, err error) {
...
func (c *priorityClasses) List(ctx context.Context, opts v1.ListOptions) (result *v1.PriorityClassList, err error) {
...
func (c *priorityClasses) Create(ctx context.Context, priorityClass *v1.PriorityClass, opts v1.CreateOptions) (result *v1.PriorityClass, err error) {
	result = &v1.PriorityClass{}
	err = c.client.Post().
		Resource("priorityclasses").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *priorityClasses) Update(ctx context.Context, priorityClass *v1.PriorityClass, opts v1.UpdateOptions) (result *v1.PriorityClass, err error) {
	result = &v1.PriorityClass{}
	err = c.client.Put().
		Resource("priorityclasses").
...
func (c *priorityClasses) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1.PriorityClass, err error) {
	result = &v1.PriorityClass{}
