...
func (c *FakeStatefulSets) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1.StatefulSet, err error) {
	obj, err := c.Fake.
...
func (c *FakeStatefulSets) List(ctx context.Context, opts v1.ListOptions) (result *v1.StatefulSetList, err error) {
	obj, err := c.Fake.
...
func (c *FakeStatefulSets) Create(ctx context.Context, statefulSet *v1.StatefulSet, opts v1.CreateOptions) (result *v1.StatefulSet, err error) {
	obj, err := c.Fake.
...
func (c *FakeStatefulSets) Update(ctx context.Context, statefulSet *v1.StatefulSet, opts v1.UpdateOptions) (result *v1.StatefulSet, err error) {
	obj, err := c.Fake.
...
func (c *FakeStatefulSets) UpdateStatus(ctx context.Context, statefulSet *v1.StatefulSet, opts v1.UpdateOptions) (*v1.StatefulSet, error) {
	obj, err := c.Fake.
...
func (c *FakeStatefulSets) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(statefulsetsResource, c.ns, name), &v1.StatefulSet{})
...
func (c *FakeStatefulSets) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1.StatefulSet, err error) {
	obj, err := c.Fake.
