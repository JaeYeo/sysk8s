...
func (c *FakeControllerRevisions) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1.ControllerRevision, err error) {
	obj, err := c.Fake.
...
func (c *FakeControllerRevisions) List(ctx context.Context, opts v1.ListOptions) (result *v1.ControllerRevisionList, err error) {
	obj, err := c.Fake.
...
func (c *FakeControllerRevisions) Create(ctx context.Context, controllerRevision *v1.ControllerRevision, opts v1.CreateOptions) (result *v1.ControllerRevision, err error) {
	obj, err := c.Fake.
...
func (c *FakeControllerRevisions) Update(ctx context.Context, controllerRevision *v1.ControllerRevision, opts v1.UpdateOptions) (result *v1.ControllerRevision, err error) {
	obj, err := c.Fake.
...
func (c *FakeControllerRevisions) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(controllerrevisionsResource, c.ns, name), &v1.ControllerRevision{})
...
func (c *FakeControllerRevisions) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1.ControllerRevision, err error) {
	obj, err := c.Fake.
