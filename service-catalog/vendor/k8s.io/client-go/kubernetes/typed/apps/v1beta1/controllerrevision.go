...
type ControllerRevisionInterface interface {
	...
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1.ControllerRevision, err error)
...
func (c *controllerRevisions) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1.ControllerRevision, err error) {
...
func (c *controllerRevisions) List(ctx context.Context, opts v1.ListOptions) (result *v1.ControllerRevisionList, err error) {
...
func (c *controllerRevisions) Create(ctx context.Context, controllerRevision *v1.ControllerRevision, opts v1.CreateOptions) (result *v1.ControllerRevision, err error) {
	result = &v1.ControllerRevision{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("controllerrevisions").
...
func (c *controllerRevisions) Update(ctx context.Context, controllerRevision *v1.ControllerRevision, opts v1.UpdateOptions) (result *v1.ControllerRevision, err error) {
	result = &v1.ControllerRevision{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("controllerrevisions").
...
func (c *controllerRevisions) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1.ControllerRevision, err error) {
	result = &v1.ControllerRevision{}
