...
func (c *FakePodDisruptionBudgets) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1.PodDisruptionBudget, err error) {
	obj, err := c.Fake.
...
func (c *FakePodDisruptionBudgets) List(ctx context.Context, opts v1.ListOptions) (result *v1.PodDisruptionBudgetList, err error) {
	obj, err := c.Fake.
...
func (c *FakePodDisruptionBudgets) Create(ctx context.Context, podDisruptionBudget *v1.PodDisruptionBudget, opts v1.CreateOptions) (result *v1.PodDisruptionBudget, err error) {
	obj, err := c.Fake.
...
func (c *FakePodDisruptionBudgets) Update(ctx context.Context, podDisruptionBudget *v1.PodDisruptionBudget, opts v1.UpdateOptions) (result *v1.PodDisruptionBudget, err error) {
	obj, err := c.Fake.
...
func (c *FakePodDisruptionBudgets) UpdateStatus(ctx context.Context, podDisruptionBudget *v1.PodDisruptionBudget, opts v1.UpdateOptions) (*v1.PodDisruptionBudget, error) {
	obj, err := c.Fake.
...
func (c *FakePodDisruptionBudgets) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(poddisruptionbudgetsResource, c.ns, name), &v1.PodDisruptionBudget{})
...
func (c *FakePodDisruptionBudgets) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1.PodDisruptionBudget, err error) {
	obj, err := c.Fake.
