...
func (c *FakeSelfSubjectAccessReviews) Create(ctx context.Context, selfSubjectAccessReview *v1.SelfSubjectAccessReview, opts v1.CreateOptions) (result *v1.SelfSubjectAccessReview, err error) {
	obj, err := c.Fake.
