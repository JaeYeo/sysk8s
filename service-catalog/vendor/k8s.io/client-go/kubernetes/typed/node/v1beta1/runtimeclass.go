...
type RuntimeClassInterface interface {
	Create(ctx context.Context, runtimeClass *v1.RuntimeClass, opts v1.CreateOptions) (*v1.RuntimeClass, error)
	Update(ctx context.Context, runtimeClass *v1.RuntimeClass, opts v1.UpdateOptions) (*v1.RuntimeClass, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1.RuntimeClass, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1.RuntimeClassList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1.RuntimeClass, err error)
...
func (c *runtimeClasses) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1.RuntimeClass, err error) {
...
func (c *runtimeClasses) List(ctx context.Context, opts v1.ListOptions) (result *v1.RuntimeClassList, err error) {
...
func (c *runtimeClasses) Create(ctx context.Context, runtimeClass *v1.RuntimeClass, opts v1.CreateOptions) (result *v1.RuntimeClass, err error) {
	result = &v1.RuntimeClass{}
	err = c.client.Post().
		Resource("runtimeclasses").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *runtimeClasses) Update(ctx context.Context, runtimeClass *v1.RuntimeClass, opts v1.UpdateOptions) (result *v1.RuntimeClass, err error) {
	result = &v1.RuntimeClass{}
	err = c.client.Put().
		Resource("runtimeclasses").
...
func (c *runtimeClasses) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1.RuntimeClass, err error) {
	result = &v1.RuntimeClass{}
