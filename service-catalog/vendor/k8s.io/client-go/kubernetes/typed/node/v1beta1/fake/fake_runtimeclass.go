...
func (c *FakeRuntimeClasses) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1.RuntimeClass, err error) {
	obj, err := c.Fake.
...
func (c *FakeRuntimeClasses) List(ctx context.Context, opts v1.ListOptions) (result *v1.RuntimeClassList, err error) {
	obj, err := c.Fake.
...
func (c *FakeRuntimeClasses) Create(ctx context.Context, runtimeClass *v1.RuntimeClass, opts v1.CreateOptions) (result *v1.RuntimeClass, err error) {
	obj, err := c.Fake.
...
func (c *FakeRuntimeClasses) Update(ctx context.Context, runtimeClass *v1.RuntimeClass, opts v1.UpdateOptions) (result *v1.RuntimeClass, err error) {
	obj, err := c.Fake.
...
func (c *FakeRuntimeClasses) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(runtimeclassesResource, name), &v1.RuntimeClass{})
	return err
}
...
func (c *FakeRuntimeClasses) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1.RuntimeClass, err error) {
	obj, err := c.Fake.
