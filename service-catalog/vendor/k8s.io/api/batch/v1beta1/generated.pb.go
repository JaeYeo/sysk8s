...
func init() {
	...
	proto.RegisterType((*JobTemplate)(nil), "k8s.io.api.batch.v1.JobTemplate")
	proto.RegisterType((*JobTemplateSpec)(nil), "k8s.io.api.batch.v1.JobTemplateSpec")
}

func init() {
	proto.RegisterFile("k8s.io/kubernetes/vendor/k8s.io/api/batch/v1/generated.proto", fileDescriptor_e57b277b05179ae7)
}
