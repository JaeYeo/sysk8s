...
func init() {
	...
	proto.RegisterType((*DeploymentRollback)(nil), "k8s.io.api.apps.v1.DeploymentRollback")
	proto.RegisterMapType((map[string]string)(nil), "k8s.io.api.apps.v1.DeploymentRollback.UpdatedAnnotationsEntry")
	...
	proto.RegisterType((*RollbackConfig)(nil), "k8s.io.api.apps.v1.RollbackConfig")
	...
	proto.RegisterMapType((map[string]string)(nil), "k8s.io.api.apps.v1.ScaleStatus.SelectorEntry")
...
func init() {
	proto.RegisterFile("k8s.io/kubernetes/vendor/k8s.io/api/apps/v1/generated.proto", fileDescriptor_2a07313e8f66e805)
}
