...
func crdStatusConditionIsTrue(status v1.CustomResourceDefinitionStatus) bool {
...
func IsServiceCatalogCustomResourceDefinition(crd v1.CustomResourceDefinition) bool {
