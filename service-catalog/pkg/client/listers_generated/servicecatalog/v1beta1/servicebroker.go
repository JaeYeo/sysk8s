...
// List lists all ServiceBrokers in the indexer for a given namespace.
func (s serviceBrokerNamespaceLister) List(selector labels.Selector) (ret []*v1.ServiceBroker, err error) {
...
// Get retrieves the ServiceBroker from the indexer for a given namespace and name.
func (s serviceBrokerNamespaceLister) Get(name string) (*v1.ServiceBroker, error) {
