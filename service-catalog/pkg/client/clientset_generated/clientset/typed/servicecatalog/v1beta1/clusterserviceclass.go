...
type ClusterServiceClassInterface interface {
	Create(ctx context.Context, clusterServiceClass *v1.ClusterServiceClass, opts v1.CreateOptions) (*v1.ClusterServiceClass, error)
	Update(ctx context.Context, clusterServiceClass *v1.ClusterServiceClass, opts v1.UpdateOptions) (*v1.ClusterServiceClass, error)
	UpdateStatus(ctx context.Context, clusterServiceClass *v1.ClusterServiceClass, opts v1.UpdateOptions) (*v1.ClusterServiceClass, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1.ClusterServiceClass, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1.ClusterServiceClassList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1.ClusterServiceClass, err error)
...
func newClusterServiceClasses(c *Servicecatalogv1Client) *clusterServiceClasses {
...
func (c *clusterServiceClasses) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1.ClusterServiceClass, err error) {
	result = &v1.ClusterServiceClass{}
	err = c.client.Get().
...
func (c *clusterServiceClasses) List(ctx context.Context, opts v1.ListOptions) (result *v1.ClusterServiceClassList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1.ClusterServiceClassList{}
	err = c.client.Get().
		Resource("clusterserviceclasses").
...
func (c *clusterServiceClasses) Create(ctx context.Context, clusterServiceClass *v1.ClusterServiceClass, opts v1.CreateOptions) (result *v1.ClusterServiceClass, err error) {
	result = &v1.ClusterServiceClass{}
	err = c.client.Post().
		Resource("clusterserviceclasses").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *clusterServiceClasses) Update(ctx context.Context, clusterServiceClass *v1.ClusterServiceClass, opts v1.UpdateOptions) (result *v1.ClusterServiceClass, err error) {
	result = &v1.ClusterServiceClass{}
	err = c.client.Put().
		Resource("clusterserviceclasses").
...
func (c *clusterServiceClasses) UpdateStatus(ctx context.Context, clusterServiceClass *v1.ClusterServiceClass, opts v1.UpdateOptions) (result *v1.ClusterServiceClass, err error) {
	result = &v1.ClusterServiceClass{}
	err = c.client.Put().
		Resource("clusterserviceclasses").
		Name(clusterServiceClass.Name).
...
func (c *clusterServiceClasses) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1.ClusterServiceClass, err error) {
	result = &v1.ClusterServiceClass{}
