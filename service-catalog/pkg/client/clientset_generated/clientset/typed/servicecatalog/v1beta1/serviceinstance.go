...
type ServiceInstanceInterface interface {
	Create(ctx context.Context, serviceInstance *v1.ServiceInstance, opts v1.CreateOptions) (*v1.ServiceInstance, error)
	Update(ctx context.Context, serviceInstance *v1.ServiceInstance, opts v1.UpdateOptions) (*v1.ServiceInstance, error)
	UpdateStatus(ctx context.Context, serviceInstance *v1.ServiceInstance, opts v1.UpdateOptions) (*v1.ServiceInstance, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1.ServiceInstance, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1.ServiceInstanceList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1.ServiceInstance, err error)
...
func newServiceInstances(c *Servicecatalogv1Client, namespace string) *serviceInstances {
...
func (c *serviceInstances) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1.ServiceInstance, err error) {
...
func (c *serviceInstances) List(ctx context.Context, opts v1.ListOptions) (result *v1.ServiceInstanceList, err error) {
...
func (c *serviceInstances) Create(ctx context.Context, serviceInstance *v1.ServiceInstance, opts v1.CreateOptions) (result *v1.ServiceInstance, err error) {
	result = &v1.ServiceInstance{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("serviceinstances").
...
func (c *serviceInstances) Update(ctx context.Context, serviceInstance *v1.ServiceInstance, opts v1.UpdateOptions) (result *v1.ServiceInstance, err error) {
	result = &v1.ServiceInstance{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("serviceinstances").
...
func (c *serviceInstances) UpdateStatus(ctx context.Context, serviceInstance *v1.ServiceInstance, opts v1.UpdateOptions) (result *v1.ServiceInstance, err error) {
	result = &v1.ServiceInstance{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("serviceinstances").
