...
type ServicePlanInterface interface {
	Create(ctx context.Context, servicePlan *v1.ServicePlan, opts v1.CreateOptions) (*v1.ServicePlan, error)
	Update(ctx context.Context, servicePlan *v1.ServicePlan, opts v1.UpdateOptions) (*v1.ServicePlan, error)
	UpdateStatus(ctx context.Context, servicePlan *v1.ServicePlan, opts v1.UpdateOptions) (*v1.ServicePlan, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1.ServicePlan, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1.ServicePlanList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1.ServicePlan, err error)
...
func newServicePlans(c *Servicecatalogv1Client, namespace string) *servicePlans {
	return &servicePlans{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *servicePlans) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1.ServicePlan, err error) {
	result = &v1.ServicePlan{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *servicePlans) List(ctx context.Context, opts v1.ListOptions) (result *v1.ServicePlanList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1.ServicePlanList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("serviceplans").
...
func (c *servicePlans) Create(ctx context.Context, servicePlan *v1.ServicePlan, opts v1.CreateOptions) (result *v1.ServicePlan, err error) {
	result = &v1.ServicePlan{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("serviceplans").
...
func (c *servicePlans) Update(ctx context.Context, servicePlan *v1.ServicePlan, opts v1.UpdateOptions) (result *v1.ServicePlan, err error) {
	result = &v1.ServicePlan{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("serviceplans").
...
func (c *servicePlans) UpdateStatus(ctx context.Context, servicePlan *v1.ServicePlan, opts v1.UpdateOptions) (result *v1.ServicePlan, err error) {
	result = &v1.ServicePlan{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("serviceplans").
...
func (c *servicePlans) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1.ServicePlan, err error) {
	result = &v1.ServicePlan{}
