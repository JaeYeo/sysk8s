...
type ServiceClassInterface interface {
	Create(ctx context.Context, serviceClass *v1.ServiceClass, opts v1.CreateOptions) (*v1.ServiceClass, error)
	Update(ctx context.Context, serviceClass *v1.ServiceClass, opts v1.UpdateOptions) (*v1.ServiceClass, error)
	UpdateStatus(ctx context.Context, serviceClass *v1.ServiceClass, opts v1.UpdateOptions) (*v1.ServiceClass, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1.ServiceClass, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1.ServiceClassList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1.ServiceClass, err error)
...
func newServiceClasses(c *Servicecatalogv1Client, namespace string) *serviceClasses {
...
func (c *serviceClasses) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1.ServiceClass, err error) {
	result = &v1.ServiceClass{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *serviceClasses) List(ctx context.Context, opts v1.ListOptions) (result *v1.ServiceClassList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1.ServiceClassList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("serviceclasses").
...
func (c *serviceClasses) Create(ctx context.Context, serviceClass *v1.ServiceClass, opts v1.CreateOptions) (result *v1.ServiceClass, err error) {
	result = &v1.ServiceClass{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("serviceclasses").
...
func (c *serviceClasses) Update(ctx context.Context, serviceClass *v1.ServiceClass, opts v1.UpdateOptions) (result *v1.ServiceClass, err error) {
	result = &v1.ServiceClass{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("serviceclasses").
...
func (c *serviceClasses) UpdateStatus(ctx context.Context, serviceClass *v1.ServiceClass, opts v1.UpdateOptions) (result *v1.ServiceClass, err error) {
	result = &v1.ServiceClass{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("serviceclasses").
...
func (c *serviceClasses) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1.ServiceClass, err error) {
	result = &v1.ServiceClass{}
