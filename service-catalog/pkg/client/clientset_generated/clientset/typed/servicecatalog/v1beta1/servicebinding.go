...
type ServiceBindingInterface interface {
	Create(ctx context.Context, serviceBinding *v1.ServiceBinding, opts v1.CreateOptions) (*v1.ServiceBinding, error)
	Update(ctx context.Context, serviceBinding *v1.ServiceBinding, opts v1.UpdateOptions) (*v1.ServiceBinding, error)
	UpdateStatus(ctx context.Context, serviceBinding *v1.ServiceBinding, opts v1.UpdateOptions) (*v1.ServiceBinding, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1.ServiceBinding, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1.ServiceBindingList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1.ServiceBinding, err error)
...
func newServiceBindings(c *Servicecatalogv1Client, namespace string) *serviceBindings {
...
func (c *serviceBindings) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1.ServiceBinding, err error) {
...
func (c *serviceBindings) List(ctx context.Context, opts v1.ListOptions) (result *v1.ServiceBindingList, err error) {
...
func (c *serviceBindings) Create(ctx context.Context, serviceBinding *v1.ServiceBinding, opts v1.CreateOptions) (result *v1.ServiceBinding, err error) {
	result = &v1.ServiceBinding{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("servicebindings").
...
func (c *serviceBindings) Update(ctx context.Context, serviceBinding *v1.ServiceBinding, opts v1.UpdateOptions) (result *v1.ServiceBinding, err error) {
	result = &v1.ServiceBinding{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("servicebindings").
...
func (c *serviceBindings) UpdateStatus(ctx context.Context, serviceBinding *v1.ServiceBinding, opts v1.UpdateOptions) (result *v1.ServiceBinding, err error) {
	result = &v1.ServiceBinding{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("servicebindings").
...
func (c *serviceBindings) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1.ServiceBinding, err error) {
	result = &v1.ServiceBinding{}
