...
type ClusterServicePlanInterface interface {
	Create(ctx context.Context, clusterServicePlan *v1.ClusterServicePlan, opts v1.CreateOptions) (*v1.ClusterServicePlan, error)
	Update(ctx context.Context, clusterServicePlan *v1.ClusterServicePlan, opts v1.UpdateOptions) (*v1.ClusterServicePlan, error)
	UpdateStatus(ctx context.Context, clusterServicePlan *v1.ClusterServicePlan, opts v1.UpdateOptions) (*v1.ClusterServicePlan, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1.ClusterServicePlan, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1.ClusterServicePlanList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1.ClusterServicePlan, err error)
...
func newClusterServicePlans(c *Servicecatalogv1Client) *clusterServicePlans {
...
func (c *clusterServicePlans) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1.ClusterServicePlan, err error) {
	result = &v1.ClusterServicePlan{}
	err = c.client.Get().
...
func (c *clusterServicePlans) List(ctx context.Context, opts v1.ListOptions) (result *v1.ClusterServicePlanList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1.ClusterServicePlanList{}
	err = c.client.Get().
		Resource("clusterserviceplans").
...
func (c *clusterServicePlans) Create(ctx context.Context, clusterServicePlan *v1.ClusterServicePlan, opts v1.CreateOptions) (result *v1.ClusterServicePlan, err error) {
	result = &v1.ClusterServicePlan{}
	err = c.client.Post().
		Resource("clusterserviceplans").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *clusterServicePlans) Update(ctx context.Context, clusterServicePlan *v1.ClusterServicePlan, opts v1.UpdateOptions) (result *v1.ClusterServicePlan, err error) {
	result = &v1.ClusterServicePlan{}
	err = c.client.Put().
		Resource("clusterserviceplans").
...
func (c *clusterServicePlans) UpdateStatus(ctx context.Context, clusterServicePlan *v1.ClusterServicePlan, opts v1.UpdateOptions) (result *v1.ClusterServicePlan, err error) {
	result = &v1.ClusterServicePlan{}
	err = c.client.Put().
		Resource("clusterserviceplans").
		Name(clusterServicePlan.Name).
...
func (c *clusterServicePlans) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1.ClusterServicePlan, err error) {
	result = &v1.ClusterServicePlan{}
