...
type ClusterServicePlanInformer interface {
	...
	Lister() v1.ClusterServicePlanLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.Servicecatalogv1().ClusterServicePlans().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.Servicecatalogv1().ClusterServicePlans().Watch(context.TODO(), options)
			},
		},
		&servicecatalogv1.ClusterServicePlan{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *clusterServicePlanInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&servicecatalogv1.ClusterServicePlan{}, f.defaultInformer)
}

func (f *clusterServicePlanInformer) Lister() v1.ClusterServicePlanLister {
	return v1.NewClusterServicePlanLister(f.Informer().GetIndexer())
}
