...
import (
	...
	v1 "github.com/kubernetes-sigs/service-catalog/pkg/client/listers_generated/servicecatalog/v1"
...
type ClusterServiceBrokerInformer interface {
	...
	Lister() v1.ClusterServiceBrokerLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.Servicecatalogv1().ClusterServiceBrokers().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.Servicecatalogv1().ClusterServiceBrokers().Watch(context.TODO(), options)
			},
		},
		&servicecatalogv1.ClusterServiceBroker{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *clusterServiceBrokerInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&servicecatalogv1.ClusterServiceBroker{}, f.defaultInformer)
}

func (f *clusterServiceBrokerInformer) Lister() v1.ClusterServiceBrokerLister {
	return v1.NewClusterServiceBrokerLister(f.Informer().GetIndexer())
}
