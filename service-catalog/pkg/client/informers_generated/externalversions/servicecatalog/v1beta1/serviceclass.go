	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.Servicecatalogv1().ServiceClasses(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.Servicecatalogv1().ServiceClasses(namespace).Watch(context.TODO(), options)
			},
		},
		&servicecatalogv1.ServiceClass{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *serviceClassInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&servicecatalogv1.ServiceClass{}, f.defaultInformer)
}

func (f *serviceClassInformer) Lister() v1.ServiceClassLister {
	return v1.NewServiceClassLister(f.Informer().GetIndexer())
}
