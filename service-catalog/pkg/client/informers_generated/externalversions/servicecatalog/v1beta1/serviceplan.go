	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.Servicecatalogv1().ServicePlans(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.Servicecatalogv1().ServicePlans(namespace).Watch(context.TODO(), options)
			},
		},
		&servicecatalogv1.ServicePlan{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *servicePlanInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&servicecatalogv1.ServicePlan{}, f.defaultInformer)
}

func (f *servicePlanInformer) Lister() v1.ServicePlanLister {
	return v1.NewServicePlanLister(f.Informer().GetIndexer())
}
