	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.Servicecatalogv1().ServiceBrokers(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.Servicecatalogv1().ServiceBrokers(namespace).Watch(context.TODO(), options)
			},
		},
		&servicecatalogv1.ServiceBroker{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *serviceBrokerInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&servicecatalogv1.ServiceBroker{}, f.defaultInformer)
}
