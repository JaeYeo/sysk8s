...
type ClusterServiceClassInformer interface {
	...
	Lister() v1.ClusterServiceClassLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.Servicecatalogv1().ClusterServiceClasses().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.Servicecatalogv1().ClusterServiceClasses().Watch(context.TODO(), options)
			},
		},
		&servicecatalogv1.ClusterServiceClass{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *clusterServiceClassInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&servicecatalogv1.ClusterServiceClass{}, f.defaultInformer)
}

func (f *clusterServiceClassInformer) Lister() v1.ClusterServiceClassLister {
	return v1.NewClusterServiceClassLister(f.Informer().GetIndexer())
}
