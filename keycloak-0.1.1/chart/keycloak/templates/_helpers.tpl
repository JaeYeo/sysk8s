...
{{- $secretName := coalesce .Values.tls.existingSecret .Values.tls.jksSecret -}}
{{- if $secretName -}}
...
{{- if and .Values.tls.enabled .Values.tls.autoGenerated (not .Values.tls.existingSecret) (not .Values.tls.jksSecret) }}
    {{- true -}}
{{- end -}}
{{- end -}}
...
{{- if and .Values.tls.enabled (not .Values.tls.autoGenerated) (not .Values.tls.existingSecret) (not .Values.tls.jksSecret) }}
