...
func getClusterServiceBroker(cli client.Client) (*v1.ClusterServiceBroker, error) {
...
func fixClusterServiceBroker() *v1.ClusterServiceBroker {
...
func fixServiceInstanceForClusterServiceClass() *v1.ServiceInstance {
...
func fixClusterServiceClass() *v1.ClusterServiceClass {
